...
if($status==false){
  ...
  while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){
      $view .= '<p>';
      $view .= '<a href="user_detail_00.php?id='.$result["id"].'">';
      $view .= $result["name"];
      $view .= '</a>　';
...
<!--    <div class="container-fluid">-->
      ...
      <a class="navbar-brand" href="user_index_00.php" style="margin-right:30px">ユーザ登録へ</a>
      <a class="navbar-brand" href="select_00.php">データ一覧へ</a>
    </div>
  </nav>
</header>
<!-- Head[End] -->
